...
[![Version](https://img.shields.io/npm/v/moa-cli-core.svg)](https://npmjs.org/package/moa-cli-core)
[![Downloads/week](https://img.shields.io/npm/dw/moa-cli-core.svg)](https://npmjs.org/package/moa-cli-core)
...
<!-- usage -->
```sh-session
$ npm install -g moa-cli-core
$ moa COMMAND
running command...
$ moa (--version)
moa-cli-core/0.0.0 win32-x64 node-v24.12.0
$ moa --help [COMMAND]
USAGE
  $ moa COMMAND
...
